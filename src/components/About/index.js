        ...
        <div className="portrait-box">
            ...
            <div className="summary-box">
                <p>Hello! I am a full stack developer based in Nashville, Tennessee. I have a background in geology and music. 
                    ...
                    I am seeking an internship in full stack, front end or back end development. I am a dedicated worker passionate about producing functional applications of the highest possible quality.
